...
public class ExamServiceTest {
    ...
    @MockBean
    private IntakeService intakeServiceMock;
...
//                .thenReturn(Optional.of(intake));
        ...
        Optional<Intake> foundIntake = this.intakeService.findById(new Long(1));
        List<Intake> allIntakes = intakeService.findAll();
        System.out.println("Danh sách Intake: " + allIntakes);
